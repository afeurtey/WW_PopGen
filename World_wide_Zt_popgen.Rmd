...
wheat_per_country = read_csv(paste0(metadata_dir, "FAOSTAT_data_4-9-2021_crops_production.csv")) %>% 
  ...
  inner_join(.,read_csv(paste0(metadata_dir, "FAOSTAT_data_4-15-2021_land_stats.csv")) %>%
...
treemix \
  ...
  -o ${POPSTR}$VCFNAME.high_anc_coef_snmf.treemix.out \
  -m 5 -root V7
...
t = plot_tree(paste0(PopStr_dir, vcf_name, ".high_anc_coef_snmf.treemix.out"))
p_cluster
```
