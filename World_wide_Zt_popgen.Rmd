...
for fq in /data2/alice/WW_project/4_TE_RIP/0_RIP_estimation/2_Aln_TE_consensus/*fq; 
do
 name=$(echo $fq | sed 's|/data2/alice/WW_project/4_TE_RIP/0_RIP_estimation/2_Aln_TE_consensus/||' | sed 's/.fq//' )
 total_reads=$(zcat /data2/alice/WW_project/4_TE_RIP/0_RIP_estimation/1_Fastq_from_bam/${name}.fq.gz | paste - - - - | wc -l | cut -f 1)
 aln_reads=$(cat /data2/alice/WW_project/4_TE_RIP/0_RIP_estimation/2_Aln_TE_consensus/${name}.fq | paste - - - - | wc -l | cut -f 1)
...
p2 = cbind(TE_PCA_mat, as.data.frame(TE.pca$x)) %>%d
