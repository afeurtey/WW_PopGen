...
#Files
vcf_name="Ztritici_global_March2021.genotyped.ALL.filtered.clean.good_samples.SNP.max-m-0.8.maf-0.05.thin-1000bp"
vcf_name_nomaf="Ztritici_global_March2021.filtered-clean.SNP.max-m-0.8.thin-1000bp"
vcf_name_mito = "Ztritici_global_March2021.genotyped.ALL.filtered.clean.good_samples.mt."
...
##CHECK WHETHER USING ONLY THE LENGTH THRESHOLD WOULD RECOVER HETEROPLASMY!!!
...
#do echo $contig > temp ; 
#   python ~/Scripts/Filter_fasta.py --list temp --action keep \
#      --out /data2/alice/WW_project/2_Population_structure/1_Mitochondrial_genome/${sample}.mitochondria.fasta \
#      /data2/alice/WW_project/0_Data/2_Denovo_assemblies/${sample}.fasta ; 
#   sed -i "s/>/>${sample}_/" /data2/alice/WW_project/2_Population_structure/1_Mitochondrial_genome/${sample}.mitochondria.fasta ; 
#done < /data2/alice/WW_project/2_Population_structure/1_Mitochondrial_genome/Complete_mitochondria_from_blast.txt

#for fasta in /data2/alice/WW_project/2_Population_structure/1_Mitochondrial_genome/*mitochondria.fasta ;  
#do  
#   sample=$(echo ${fasta} | cut -f 7 -d "/") ; 
#   echo $fasta $sample ; 
#   ./dnadiff \
#       -p /data2/alice/WW_project/2_Population_structure/1_Mitochondrial_genome/Aln_vs_IPO323/IPO323_vs_${sample%.mitochondria.fasta} 
#       /data2/alice/WW_project/0_Data/Zymoseptoria_tritici.MG2.dna.toplevel.mt+_only.fa $fasta ; 
#done
