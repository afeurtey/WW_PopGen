...
rm /data3/alice/Aln_essai/BAM_TE/${p}.TE.sam
gzip /data3/alice/Aln_essai/Fastq_from_bam/${p}.fq
rm /data3/alice/Aln_essai/BAM_TE/${p}.TE.unmapped.bam
rm /data3/alice/Aln_essai/BAM_TE/${p}.TE.mapped.bam
