...
depth_per_gene %>%
  dplyr::select(ID_file, Locus_name, 
                Gene_ID, Depth, Median_core_depth, Normalized_depth, 
                Rounded_norm, effector) %>%
  write_tsv(paste0(VAR_dir,"2_Depth_per_gene/All_samples.tab"))
